 ...
 *      基于Kafka进行数据更新操作
 */
public class FlinkTableKafkaUpsert {
    public static void main(String[] args) throws Exception {
        ...
        String createKafkaSinkTable = "CREATE TABLE student_kafka_upsert_sink (\n" +
                "  name STRING,\n" +
                "  score DOUBLE,\n" +
                "  num BIGINT,\n" +
        ...
        queryTableResult.executeInsert("student_kafka_upsert_sink");



//        env.execute("FlinkTableKafkaUpsert Test Job");
    }
}
